...
class Test_face_recognition(unittest.TestCase):
    ...
    def test_load_image_file(self):
        img = api.load_image_file(os.path.join(os.path.dirname(__file__), 'test_images', 'Student.jpg'))
    ...
    def test_partial_face_locations(self):
        img = api.load_image_file(os.path.join(os.path.dirname(__file__), 'test_images', 'Student_partial_face.jpg'))
        detected_faces = api.face_locations(img)

        self.assertEqual(len(detected_faces), 1)
        self.assertEqual(detected_faces[0], (142, 191, 365, 0))

        img = api.load_image_file(os.path.join(os.path.dirname(__file__), 'test_images', 'Student_partial_face2.jpg'))
        detected_faces = api.face_locations(img)
    ...
    def test_face_distance(self):
        img_a1 = api.load_image_file(os.path.join(os.path.dirname(__file__), 'test_images', 'Student.jpg'))
        img_a2 = api.load_image_file(os.path.join(os.path.dirname(__file__), 'test_images', 'Student2.jpg'))
        img_a3 = api.load_image_file(os.path.join(os.path.dirname(__file__), 'test_images', 'Student3.jpg'))
    ...
    def test_command_line_interface(self):
        target_string = 'Student.jpg,Student'
        runner = CliRunner()
        image_folder = os.path.join(os.path.dirname(__file__), 'test_images')
        image_file = os.path.join(os.path.dirname(__file__), 'test_images', 'Student.jpg')
    ...
    def test_command_line_interface_big_image(self):
        target_string = 'Student3.jpg,Student'
        runner = CliRunner()
        image_folder = os.path.join(os.path.dirname(__file__), 'test_images')
        image_file = os.path.join(os.path.dirname(__file__), 'test_images', 'Student3.jpg')
    ...
    def test_command_line_interface_show_distance(self):
        target_string = 'Student.jpg,Student,0.0'
        runner = CliRunner()
        image_folder = os.path.join(os.path.dirname(__file__), 'test_images')
        image_file = os.path.join(os.path.dirname(__file__), 'test_images', 'Student.jpg')
    ...
    def test_fd_command_line_interface(self):
        ...
        self.assertTrue("Student.jpg" in parts[0])
    ...
    def test_fd_command_line_interface_folder(self):
        ...
        result = runner.invoke(face_detection_cli.main, args=[image_file])
        self.assertEqual(result.exit_code, 0)
        self.assertTrue("Student_partial_face2.jpg" in result.output)
        self.assertTrue("Student.jpg" in result.output)
        self.assertTrue("Student2.jpg" in result.output)
        self.assertTrue("Student3.jpg" in result.output)
        self.assertTrue("biden.jpg" in result.output)

    def test_fd_command_line_interface_hog_model(self):
        target_string = 'Student.jpg'
        runner = CliRunner()
        image_file = os.path.join(os.path.dirname(__file__), 'test_images', 'Student.jpg')
